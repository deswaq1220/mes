...
public class Ratio {
    ...
    //마늘즙
    final static public double gallicInputQty = waterOrderInputQty / 120;           //마늘 투입량(단위: kg)
    final static public double gallicWaterInput = (waterOrderInputQty / 120) * 3;   //마늘즙 만들 때 필요한 정제수량(단위: kg)
    final static public double blackGallicWater = gallicInputQty + gallicWaterInput; //흑마늘즙 추출 시 투입량(단위: kg)
    final static public double blackGallicOutput = blackGallicWater * 0.6;           //흑마늘추출액(단위: kg)
